...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    timeline: [
      ...
      { time: "18:30", event: "Entrance of the Couple" },
      { time: "19:30", event: "Dinner" },
      { time: "21:00", event: "Cake Cutting" },
      { time: "23:00", event: "Family Entrance & Congratulations" },
      { time: "00:00", event: "Farewell" },
    ],
    ...
    faqItems: [
      ...
      { question: "Is there parking available?", answer: "Yes, there are 300 free parking spots available at the venue." },
    ],
  ...
  ar: {
    ...
    time: "\u0627\u0644\u062A\u0648\u0642\u064A\u062A",
    timeValue: "\u0666:\u0660\u0660 \u0645\u0633\u0627\u0621\u064B",
    womensHall: "\u0642\u0627\u0639\u0629 \u0627\u0644\u0646\u0633\u0627\u0621",
    mensHall: "\u0642\u0627\u0639\u0629 \u0627\u0644\u0631\u062C\u0627\u0644",
    viewOnMap: "\u0639\u0631\u0636 \u0639\u0644\u0649 \u0627\u0644\u062E\u0631\u064A\u0637\u0629",
    programTimeline: "\u0628\u0631\u0646\u0627\u0645\u062C \u0627\u0644\u062D\u0641\u0644",
    timeline: [
      { time: "١٨:٠٠", event: "بداية الحفل" },
      { time: "١٨:٣٠", event: "دخلة العرسان" },
      { time: "١٩:٣٠", event: "العشاء" },
      { time: "٢١:٠٠", event: "قطع الكاتو" },
      { time: "٢٣:٠٠", event: "دخلة الأهل والتهاني" },
      { time: "٠٠:٠٠", event: "الوداع" },
    ],
    ...
    faqItems: [
      ...
      { question: "هل يتوفر موقف سيارات؟", answer: "نعم، يتوفر 300 موقف سيارات مجاني في المكان." },
    ],
